...
abstract class Defence {
	   ...
	   abstract void attack();
		...
		public String toString() {
		 	return "NameOfHead is :"+this.NameOfHead+"/"+this.NoOfVehicle+"/"+this.LocationOfHeadQuartor+"/"+this.CountryName+"/"+this.NoOfBoss+"/"+this.Budgets+"/"+this.NoOfDepartment+"/"+this.NoOfMissionPerformed+"/"+this.ManPowerCount+"/"+this.NoOfProof;
	}
		...
		class Army extends Defence{
				...
				public String toString() {
				 	return super.toString()+"NoOfTank is :"+this.NoOfTank+"/"+this.NoOfGun+"/"+this.NoOfGrander+"/"+this.NoOfBatallian;
			}
		}
		...
		class Navy extends Defence{
			...
			public String toString() {
			 	return super.toString()+"NoOfShip is :"+this.NoOfShip+"/"+this.NoOfSubmariens+"/"+this.NoOfTorpedes;
		}
		...
		public String toString() {
		 	return super.toString()+"NoOfMissiles is :"+this.NoOfMissiles+"/"+this.Aircraft+"/"+this.NoOfSquadron;
	}
}
...
class TestDefence{
			public static void main(String[] args) {
				...
				d1 = new Army("General Manoj Pande", 5000, "New Delhi", "India",12, 4500000.85, 10, 180, 1300000, 60,3500, 12000, 50000, 45);
				System.out.println(d1.toString());
				d1.attack();
				System.out.println("***************************************************************");
				d1 = new Navy("Admiral R. Hari Kumar", 1200, "New Delhi", "India",8, 2500000.75, 5, 75, 75000, 30, 150, 20, 500);
				System.out.println(d1.toString());
				d1.attack();
				System.out.println("***************************************************************");
				d1 = new AirForce("Air Chief Marshal Vivek Ram Chaudhari", 900, "New Delhi", "India",7, 3200000.50, 6, 95, 140000, 25, 800, 300, 15);
				System.out.println(d1.toString());
				d1.attack();
				System.out.println("***************************************************************");
			}
