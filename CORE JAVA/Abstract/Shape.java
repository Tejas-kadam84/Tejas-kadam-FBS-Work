...
abstract class Shape {
    ...
    public String toString(){
    	return "color is:"+this.color+"/"+this.borderWidth+"/"+this.area;
    }
...
class Rectangle extends Shape {
    ...
    public String toString(){
    	return super.toString()+ "length is :"+this.length+"/"+this.width;
    }
...
class Triangle extends Shape {
    ...
    public String toString(){
    	return super.toString()+"base is :"+this.base+"/"+this.height;
    }
